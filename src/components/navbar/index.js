            ...
            <div>
                <div id="sidenav">
                    ...
                    <div id="resourceLinks">
                        ...
                        <a className="fa fa-file-text" href="https://github.com/jjmateer/React-portfolio/files/3871876/JPM-Resume.pdf"> </a>
                    </div>
                </div >
                <div id="topnav">
                    <Link id="logo" to="/">jpm</Link>
                    ...
                    <Menu noOverlay isOpen={this.state.menuOpen}
                        ...
                        <a onClick={() => this.toggleMenu()} href="https://github.com/jjmateer/React-portfolio/files/3871876/JPM-Resume.pdf">Resume</a>
                    </Menu>
                </div >
            </div>
        )
